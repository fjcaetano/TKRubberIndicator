...
// ValueChange
public typealias UIControlValueChangeClosure = (Any) -> Void
...
open class TKRubberPageControl : UIControl {
    ...
    // 事件闭包
    open var valueChange  : UIControlValueChangeClosure?
    // 样式配置
    ...
    fileprivate func setUpView(){
        ...
        let w = CGFloat(numberOfPages - 2) * styleConfig.smallBubbleSize + styleConfig.mainBubbleSize + CGFloat(numberOfPages) * styleConfig.bubbleXOffsetSpace
